...
"""
function get_file(serv::PyObject, container::String, object_name::String, fname::String; verbose::Bool=false)
...
"""
function get_file(func::Function, serv::PyObject, container::String, object_name::String; verbose::Bool=false)
...
function get_stream(func::Function, serv::PyObject, container::String, object_name::String; verbose::Bool=false)
...
function get_jld(serv::PyObject, container::String, object_name::String, datanames...; verbose::Bool=false)
    get_file(serv::PyObject, container, object_name; verbose=verbose) do fname
